/**
 * Ledger account create/update/reorder, same idiom as
...
export async function createLedgerAccount(
  ...
  householdId: string,
  input: LedgerAccountCreateInput
  ...
  return toLedgerAccount(data as LedgerAccountRow);
}
...
export async function updateLedgerAccount(
  ...
  const patch: Partial<LedgerAccountRow> = {};
  ...
  if (error) throw new Error(error.message);
  return data ? toLedgerAccount(data as LedgerAccountRow) : null;
}
