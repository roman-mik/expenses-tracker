...
**Status:** completed, all 5 slices shipped (2026-08-19) · **Spec:** `docs/ledger-user-stories.md` §5 Epic A · **Plan of record:** `PLAN.md` §9
...
| 5 | `feat: add ledger balance reconciliation` | A4 — migration 0016, reconcile panel | ✅ Done |
